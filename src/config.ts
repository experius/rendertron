...
export class ConfigManager {
  public static config: Config = {
    ...
    querySelectorAll: 'main > [class*="-bannerImage-"], main > [class*="main-page-"], main > [class*="-RootComponents-"], [class*="-breadcrumbs-"], main > [class*="-errorView-"], main > [class*="-layoutContainer-"], main > [class*="-productFullDetail-"], main > [class*="-ProductFullDetail-"], main > div > [class*="-components-base-grid-"], main > div > [class*="-contentBlocks-"], main > div > [class*="-summaryFinder-"], main > h1'
  };
